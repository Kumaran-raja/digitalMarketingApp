...
public class Task9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("Task9Prefs", MODE_PRIVATE);
        ...
        submittask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isButtonClickable()) {
                    Toast.makeText(Task9.this, "Task 9 Today Already Completed", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Intent i = new Intent(Task9.this, Today_task.class);
        ...
        profileref.child(Objects.requireNonNull(mAuth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    String description="Task 9 Amount";
                    DatabaseReference value = PayoutHistory.child(mAuth.getUid()).child(profileid).child("Task9");
        ...
        profileref.child(Objects.requireNonNull(mAuth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(Task9.this, "", Toast.LENGTH_SHORT).show();
        ...
        if (uid != null) {
            ...
            myRef.setValue(updatedTaskWalletAmount)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(Task9.this, "Task 9 amount Added Successfully", Toast.LENGTH_SHORT).show();
                    })
                    .addOnFailureListener(e -> {
                        // Handle failure
                        Toast.makeText(Task9.this, "Task 9 amount cannot Added Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                    });
        }
    }
