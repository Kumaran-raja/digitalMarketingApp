...
public class Task7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("Task7Prefs", MODE_PRIVATE);
        ...
        submittask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isButtonClickable()) {
                    Toast.makeText(Task7.this, "Task 7 Today Already Completed", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Intent i = new Intent(Task7.this, Today_task.class);
        ...
        profileref.child(Objects.requireNonNull(mAuth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    String description="Task 7 Amount";
                    DatabaseReference value = PayoutHistory.child(mAuth.getUid()).child(profileid).child("Task7");
        ...
        profileref.child(Objects.requireNonNull(mAuth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Toast.makeText(Task7.this, "", Toast.LENGTH_SHORT).show();
        ...
        if (uid != null) {
            ...
            myRef.setValue(updatedTaskWalletAmount)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(Task7.this, "Task 7 amount Added Successfully", Toast.LENGTH_SHORT).show();
                    })
                    .addOnFailureListener(e -> {
                        // Handle failure
                        Toast.makeText(Task7.this, "Task 7 amount cannot Added Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                    });
        }
    }
