        ...
        submittask.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isButtonClickable()) {
                    Toast.makeText(Task7.this, "Task7 Today Already Completed", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        profileref.child(Objects.requireNonNull(mAuth.getUid())).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    String description="Task7 Amount";
        ...
        if (uid != null) {
            ...
            myRef.setValue(updatedTaskWalletAmount)
                    .addOnSuccessListener(aVoid -> {
                        ...
                        Toast.makeText(Task7.this, "Task3 amount Added Successfully", Toast.LENGTH_SHORT).show();
                    })
                    .addOnFailureListener(e -> {
                        // Handle failure
                        Toast.makeText(Task7.this, "Task3 amount cannot Added Check Your Internet Connection", Toast.LENGTH_SHORT).show();
                    });
        }
    }
